        ...
        >
          ...
          <div className="bg-white dark:bg-[#121826] text-slate-800 dark:text-white rounded-2xl p-4 flex flex-col items-center shadow-lg w-full max-w-sm border border-slate-200 dark:border-slate-800/80 hover:shadow-xl transition-all duration-300">
            ...
            <div className="flex gap-6 text-2xl">
              <a href="https://github.com/thecetinkaya" target="_blank" rel="noopener noreferrer" className="hover:text-[#13d179] hover:scale-110 transition duration-150">
                <FaGithub />
              </a>
              <a href="https://linkedin.com/in/thecetinkaya" target="_blank" rel="noopener noreferrer" className="hover:text-[#13d179] hover:scale-110 transition duration-150">
                <FaLinkedin />
              </a>
              <a href="https://twitter.com/xburakcetinkaya" target="_blank" rel="noopener noreferrer" className="hover:text-[#13d179] hover:scale-110 transition duration-150">
                <FaTwitter />
              </a>
              <a href="https://instagram.com/thecetinkaya" target="_blank" rel="noopener noreferrer" className="hover:text-[#13d179] hover:scale-110 transition duration-150">
                <FaInstagram />
              </a>
            </div>
          </div>
